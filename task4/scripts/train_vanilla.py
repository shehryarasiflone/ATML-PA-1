...
def train_vanilla():
    ...
    print("Training Vanilla CIFAR-10 ResNet-18 (100 epochs, Cosine Annealing)...")
    ...
    print("\n" + "="*50)
    print(f"Vanilla Best Val Acc  : {best_val_acc:.2f}%")
    print(f"Vanilla Test Acc (CSA): {test_acc:.2f}%")
    print("="*50)
